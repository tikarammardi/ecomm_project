...
<div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea name="short_desc" id="" cols="10" rows="3" class="form-control" value="<?php echo $short_desc; ?>"></textarea>
    </div>
...
<!-- Product Tags
 ...
 -->
    ...
    <div class="form-group">
        ...
        <img src="../../resources/<?php echo $product_image; ?>" width="200" alt="image is here">
